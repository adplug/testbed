 ...
 *
 * binwrap.cpp - Binary file I/O wrapper, using standard iostreams library
...
unsigned long biniwstream::read(void *buf, unsigned long length)
{
...
void binowstream::write(const void *buf, unsigned long length)
{
